...
const AUTO_MAP: Record<string, string[]> = {
  company_name: ['company_name', 'namn', 'bolagsnamn', 'företagsnamn', 'name', 'company'],
  org_number: ['org_number', 'organisationsnummer', 'orgnr', 'org_nr', 'orgnummer'],
  registration_date: ['registration_date', 'registreringsdatum', 'reg_date', 'datum'],
  company_form: ['company_form', 'bolagsform', 'företagsform'],
  sni_code: ['sni_code', 'sni_kod', 'sni', 'branschkod'],
  industry_label: ['industry_label', 'bransch', 'industry', 'verksamhet'],
  address: ['address', 'adress', 'gatuadress'],
  postal_code: ['postal_code', 'postnummer', 'postnr', 'zip'],
  city: ['city', 'stad', 'ort', 'postort'],
  municipality: ['municipality', 'kommun'],
  county: ['county', 'lan', 'län'],
  website_url: ['website_url', 'hemsida', 'website', 'url', 'webb'],
  website_status: ['website_status', 'hemsidestatus'],
  phone_number: ['phone_number', 'telefon', 'telefonnummer', 'phone', 'tel'],
