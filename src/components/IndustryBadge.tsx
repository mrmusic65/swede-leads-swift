...
const INDUSTRY_COLORS: Record<string, string> = {
  ...
  'Städ & Fastighet': 'bg-teal-50 text-teal-700 border-teal-200/60',
  'Städ & Facility': 'bg-teal-50 text-teal-700 border-teal-200/60',
  'Flytt & Transport': 'bg-orange-50 text-orange-700 border-orange-200/60',
